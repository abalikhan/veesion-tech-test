...
class DinoV2VariableAdapters(nn.Module):
    """
    ...
    def forward(self, pixel_values: torch.Tensor):
        ...
        for idx, blk in enumerate(self.blocks):
            ...
            if str(idx) in self.adapters:
                ...
                x = torch.cat([cls.unsqueeze(1), x[:, 1:, :]], dim=1)
        # final layer norm
